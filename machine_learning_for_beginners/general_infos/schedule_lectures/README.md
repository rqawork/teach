...
|03.12.2026  (Thu) | Simple ANNs (Feedforward networks, activation functions, basic training) |
|10.12.2026  (Thu) | Gaussian Processes (Kernels, conditional distributions) |
|17.12.2026  (Thu) | Design of Experiments (DoE, random design, active learning, bayesian optimization) |
|07.01.2027  (Thu) | Extra exercises / projects (Tutor: Subhash) |
|14.01.2027  (Thu) | Extra exercises / projects |
