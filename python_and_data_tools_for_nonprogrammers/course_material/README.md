...
### Exercises
Some zip files might contain extra txt and png files inside. Unpack the zip file for the chosen topic in your PC, leaving all unpacked files on the same folder, then run the jupyter notebook (.ipynb) file from there.
...
- [2 - Tuples/Sets/Dictionaries](/teach/python_and_data_tools_for_nonprogrammers/course_material/exercises/2_Tuples_Sets_Dictionaries/exercises2_tuples_sets_dictionaries.zip)
- [3 - If & For](/teach/python_and_data_tools_for_nonprogrammers/course_material/exercises/3_If_For/exercises3_if_for.zip)
...
- [3 - If statements / for loops](/teach/python_and_data_tools_for_nonprogrammers/course_material/solutions/solution3_if_for.zip)
